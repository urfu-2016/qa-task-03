...
describe('getPokerHand', () => {
    ...
    it(`should throw error when dice is not number`, () => {
        const cb = () => getPokerHand([6, 1, 2, '3', 7]);

        assert.throws(cb, /Invalid dice at place 3 with value 3/);
    });
    it(`should throw error when dice is not integer`, () => {
        const cb = () => getPokerHand([6, 1, 2, 3.23, 7]);

        assert.throws(cb, /Invalid dice at place 3 with value 3.23/);
    });
});
