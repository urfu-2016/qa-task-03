...
describe('getPokerHand', () => {
    ...
    it('Должен выкидывать ошибку, когда значения кубиков больше 6', () => {
        const cb = () => getPokerHand([1, 2, 3, 10, 7]);

        assert.throws(cb, /Значения должны быть целыми числами и иметь значения от 1 до 6/);
    });

    it('Должен выкидывать ошибку, когда значения кубиков меньше 1', () => {
        const cb = () => getPokerHand([1, -1, 3, 0, 6]);
