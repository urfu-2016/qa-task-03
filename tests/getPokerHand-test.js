...
describe('getPokerHand', () => {
    ...
    it('should throw `Длина входного массива должна быть равна 5` for [1,2,3,4,5,6]', () => {
        const actual = () => getPokerHand([1,2,3,4,5,6]);
        
        assert.throws(actual, /Длина входного массива должна быть равна 5/);
    });
    
    it('should throw `Элементами массива должны быть целые числа в интервале от 1 до 6` for [1,2,3,4,7]', () => {
        const actual = () => getPokerHand([1,2,3,4,7]);
        
        assert.throws(actual, /Элементами массива должны быть числа в интервале от 1 до 6/);
    });
    
    it('should throw `На вход должен подаваться массив` for "hello"', () => {
        const actual = () => getPokerHand("hello");
        
        assert.throws(actual, /На вход должен подаваться массив/);
    });
    
    it('should throw `Элементами массива должны быть целые числа в интервале от 1 до 6` for [1,2,3,4,"h"]', () => {
        const actual = () => getPokerHand([1,2,3,4,"h"]);
        
        assert.throws(actual, /Элементами массива должны быть целые числа/);
    });
	
	it('should throw `Элементами массива должны быть числа в интервале от 1 до 6` for [1,2,3,4,-1]', () => {
        const actual = () => getPokerHand([1,2,3,4,-1]);
        
        assert.throws(actual, /Элементами массива должны быть числа в интервале от 1 до 6/);
    });
	
	it('should throw `Элементами массива должны быть целые числа` for [1,2,3,4,1.2]', () => {
        const actual = () => getPokerHand([1,2,3,4,1.2]);
