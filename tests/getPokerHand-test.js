...
describe('getPokerHand', () => {
    ...
    it('should return `Элементами массива должны быть целые числа в интервале от 1 до 6` for [1,2,3,4,7]', () => {
        const actual = () => getPokerHand([1,2,3,4,7]);
        
        assert.throws(actual, /Элементами массива должны быть целые числа в интервале от 1 до 6/);
    });
    ...
    it('should return `Элементами массива должны быть целые числа в интервале от 1 до 6` for [1,2,3,4,"h"]', () => {
        const actual = () => getPokerHand([1,2,3,4,"h"]);
        
        assert.throws(actual, /Элементами массива должны быть целые числа в интервале от 1 до 6/);
    });
	
	it('should return `Элементами массива должны быть целые числа в интервале от 1 до 6` for [1,2,3,4,-1]', () => {
        const actual = () => getPokerHand([1,2,3,4,"-1"]);
        
        assert.throws(actual, /Элементами массива должны быть целые числа в интервале от 1 до 6/);
    });
	
	it('should return `Элементами массива должны быть целые числа в интервале от 1 до 6` for [1,2,3,4,1.2]', () => {
