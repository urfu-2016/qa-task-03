...
describe('getPokerHand', () => {
    ...
    it('should return `Пара` for [1, 1, 4, 2, 3]', () => {
        const actual = getPokerHand([1, 1, 4, 2, 3]);
