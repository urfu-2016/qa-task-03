...
describe('getPokerHand', () => {
    ...
    // Проверка, когда ничего не передаем

    it('should throw `Необходимо подавать массив` for empty entry', () => {
    assert.throws(() => getPokerHand(), 'Необходимо подавать массив');
    ...
    it('should throw `Массив должен состоять из 5 элементов` for [1,2,3,4,5,6]', () => {
    assert.throws(() => getPokerHand([1, 2, 3, 4, 5, 6]), 'Массив должен состоять из 5 элементов');
